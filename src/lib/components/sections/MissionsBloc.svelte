...
<div class="bg-white dark:bg-gray-800">
	<div class="text-center w-full mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 z-20">
		<h2 class="text-3xl font-extrabold text-black dark:text-white sm:text-4xl">
			...
			<span class="block text-xl text-blue-500"
		...
		<div class="flex-wrap items-center justify-center gap-8 text-center sm:flex">
			<div
				class="max-w-sm p-6 bg-white rounded-lg shadow-lg sm:w-1/2 md:w-1/2 lg:w-1/4 dark:bg-gray-800 dark:border-gray-700"
			>
				<svg
